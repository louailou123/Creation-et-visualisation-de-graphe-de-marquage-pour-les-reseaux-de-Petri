...
import petriGraphe.Affichage.AffichageStochastique;
import petriGraphe.Graphes.GrapheStochastique;
import petriGraphe.AbstractClasses.AbstractGrapheMarquage;

public class GrapheMarquageStochastique extends AbstractGrapheMarquage {
       private GrapheStochastique graphe;
       private Set<AffichageStochastique> Resultat=new LinkedHashSet<>();
     public GrapheMarquageStochastique(GrapheStochastique graphe) {
        this.graphe=graphe;
    ...
    public void affichergraphe()
    {
      ...
      for(AffichageStochastique a : this.Resultat)
      {
